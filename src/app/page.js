...
export default function RegisFormPage() {
  ...
  const [isUserAgreed, setiUA] = useState(false);
  ...
  const cbTermsonChange = (event) => {
    setiUA(event.target.checked);
  };
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        ...
        <div className={genderError ? "text-danger" : ""}>
      ...
      <div>
        ...
        <span className="text-success d-block">
          {buyBottle && buyCap && buyShoes ? "(20% Discounted)" : ""}
        </span>
      </div>
